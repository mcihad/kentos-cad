...
| Pencereler ve paneller | 51 | 51 | 0 | 0 |
...
Masaüstü kabuğu (apps/desktop) 24 / 164 komutu çalıştırıyor; öbürleri şeritte soluk durur ve “masaüstüne henüz taşınmadı” der (docs/adr/0017). Liste: apps/desktop/ported.json.

## Test başvurusu

99 / 164 komutun kimliği hiçbir test dosyasında ya da e2e betiğinde geçmiyor. Kimliğin bir testte geçmesi davranışın sınandığını göstermez; kabul kanıtı değildir.
