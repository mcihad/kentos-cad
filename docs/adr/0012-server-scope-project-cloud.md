...
- **Eski “backend henüz yok” notları geçersizdir.** Sunucu vardır (CLAUDE.md §1, §13). Eksik olan kişisel alan, proje düzeyinde yetki ve paylaşım, binary revizyonlar, nesne deposu ve kalıcı worker'dır. Binary revizyonlar ve ilk nesne deposu (sunucunun klasörü) 26 Eylül'de geldi: [ADR 0031](0031-cloud-file-projects.md).
