...
- **Web'le fark:** masaüstünde seçimin çizgisi düzdür. Web'de 6/3 kesiklidir (DESIGN.md). wgpu çizim hattında kesik çizgi yoktur (`REN-11`). Sahibin sorusu açıktır, ertelenenlere bakın.
