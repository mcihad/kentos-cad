...
| --------------------------- | ----------------------------------------------------------- | -------------------------------- | ----------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Proje ayarları**          | `model/projectSettings.ts` → `doc.settings`                 | Proje dosyası (.kcad)            | Projeyi açan herkes                 | SRID, uzunluk ve alan hassasiyeti, alan birimi, açı birimi, çizim ölçeği, proje adı, çalışma modu (§4.12)                                                                                                                                                                                                   |
...
| `app/appearance.test.ts` | Görünüm: varsayılanların lacivert ve Plus Jakarta Sans olması, amber dışındaki her vurgunun iki temada her jetonu tanımlaması, sistem dışındaki her yazı tipinin Latin ve Latin Extended yüzünün yerel dosyadan (başka sunucu yok) gelmesi, dosyaların ve OFL lisansının var olması |
...
apps/web/src/
  ...
  app/                       Kompozisyon kökü
    ...
    appearance.ts            Kullanıcının görünüm seçimleri: vurgu renkleri (`ACCENTS`, `styles/accents.css`) ve arayüz yazı tipleri (`UI_FONTS`, `styles/fonts.css`), uygulanmaları
  ...
  ui/
    ...
    icons.ts                 Simge seti
  assets/fonts/              Uygulamayla gelen arayüz yazı tipleri (woff2, Latin ve Latin Extended; her klasörde OFL lisansı): Plus Jakarta Sans, Inter, IBM Plex Sans, Source Sans 3, Noto Sans, Roboto, IBM Plex Mono ve çizimdeki yazıların Barlow'u
