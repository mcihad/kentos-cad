...
- Desktop Rust ile; `kentos-rc` 25 Eylül'de bu depoya `crates/ui`
  ...
  uyarılar), F4 ile paneller, tam ekran, komut arama ve sunucu denetimi vardır (ADR 0058); çizimin
  yazıları (yazı nesnesi, ölçü değeri, etiket; projenin yazı tipiyle), ölçü çizgileri ve yardımcı
  çizgiler çizilir (ADR 0055); yazı aracı henüz yok.
...
Kapalı alan, çizgi, çoklu çizgi, nokta, daire, yay, dikdörtgen ve düzgün çokgen dışındaki desktop çizim araçları, alan araçları (birleştir, kesiştir, çıkar, böl, alana çevir), çizim alanında yazı ve tutamaçlar, embed Python, tam AI yüzeyi,
