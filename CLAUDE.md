...
- Desktop Rust ile; `kentos-rc` 25 Eylül'de bu depoya `crates/ui`
  ...
  seçim, kenet ve silme vardır (ADR 0029); çizimin yazıları (yazı nesnesi, ölçü değeri, etiket;
  projenin yazı tipiyle), ölçü çizgileri ve yardımcı çizgiler çizilir (ADR 0055); yazı aracı henüz yok.
