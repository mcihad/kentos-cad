...
Masaüstünde alan araçları (birleştir, kesiştir, çıkar, böl, alana ve çoklu çizgiye çevir, sınır), ölçme, parsel, aplikasyon ve ifraz araçları, hesaplar, işlemler, stil düzenleyicileri, sağ tık menüleri ve çizim alanında tutamaçlar, embed Python, tam AI yüzeyi,
