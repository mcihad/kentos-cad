...
- Desktop Rust ile; `kentos-rc` 25 Eylül'de bu depoya `crates/ui`
  ...
  ölçülendirme: hizalı, doğrusal, açı, yarıçap ve çap (ADR 0061);
...
Masaüstünde tarama aracı, alan araçları (birleştir, kesiştir, çıkar, böl, alana ve çoklu çizgiye çevir, sınır), ölçme, parsel, aplikasyon ve ifraz araçları, hesaplar, işlemler, stil düzenleyicileri, sağ tık menüleri ve çizim alanında tutamaçlar, embed Python, tam AI yüzeyi,
