...
- Desktop Rust ile; `kentos-rc` 25 Eylül'de bu depoya `crates/ui`
  ...
  revizyon bulutu, kot noktası ve böl (ADR 0057); taşı, kopyala, döndür, ölçekle ve aynala (ADR 0037);
...
Masaüstünde yazı, ölçü ve tarama araçları, alan araçları (birleştir, kesiştir, çıkar, böl, alana ve çoklu çizgiye çevir, sınır), ölçme, parsel, aplikasyon ve ifraz araçları, hesaplar, işlemler, stil düzenleyicileri, sağ tık menüleri ve çizim alanında tutamaçlar, embed Python, tam AI yüzeyi,
