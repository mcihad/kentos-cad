...
Kapalı alan, çizgi, çoklu çizgi, nokta, daire, yay, dikdörtgen ve düzgün çokgen dışındaki desktop çizim araçları, ötele ve dizi gibi öbür değiştirme araçları, çizim alanında yazı ve tutamaçlar, embed Python, tam AI yüzeyi,
...
cargo test -p kentos-native-application   # ürün komutlarının durumları masaüstünde (fixtures/commands, ADR 0022, 0027, 0029, 0032, 0037)
...
Kilitli katmandaki nesnenin kopyası da yapılmaz (ADR 0037).
