...
//! and the project's styles. The edits are in `edit.rs`, transactions and the
//! undo history in `history.rs`, reading and writing snapshots in
//! `snapshot.rs`.

use kentos_contracts::{Bounds, Entity, ProjectSettings, ProjectStyles, Vec2};
