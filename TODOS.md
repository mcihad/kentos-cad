...
- [ ] `UI-11` İlk desktop shell'i mevcut web menü/komut envanterinden kur: proje aç/kaydet, ribbon, layer tree, properties, status, command input, settings ve cloud durumu. — **25 Eylül, kısmen:** `apps/desktop` ([ADR 0017](docs/adr/0017-desktop-shell.md)).
  ...
  - Taşınan komut 103/167 (26 Eylül; `apps/desktop/ported.json`, envanterde masaüstü sütunu).
  ...
  - Kalanlar: ölçü ve tarama araçları; alan araçları; ölçme, parsel, aplikasyon ve ifraz araçları; hesaplar (`calc.*`), işlemler, stil düzenleyicileri, bulut komutlarının kalanı, sağ tık menüleri.
