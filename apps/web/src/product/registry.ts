...
/**
 * The product commands the web runs (docs/adr/0013, 0022, 0027, 0029, 0032).
 ...
 */
export const WEB_COMMANDS: readonly ProductCommand<never, unknown, unknown>[] = [polygonCreate, lineCreate, polylineCreate, entitiesDelete, pointCreate, circleCreate, arcCreate];
