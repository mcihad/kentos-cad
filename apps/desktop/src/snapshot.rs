...
//! [--tumu] [--merkez Y,X] [--yakinlastir <kat>]`: the window drawn without
//! opening one (the KentOS UI snapshot renderer), for visual checks and
//! documentation. Nothing is written but the image.
//!
...
const USAGE: &str = "kullanım: kentos-cad snapshot çıktı.png [çizim.kcad] [--sekme <id>] [--tema acik] \
                     [--tumu] [--merkez Y,X] [--yakinlastir <kat>]";
